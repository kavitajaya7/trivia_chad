...
import '../thumbs-up-unicorn/ThumbsUpUnicorn.css';
import './SleepingUnicorn.css';

const SleepingUnicorn = (): JSX.Element => {
    return (
        <svg
                ...
                <g xmlns="http://www.w3.org/2000/svg">
                    <g>
                        ...
                        <path
                            ...
                            fill="#e1bdfc"
                            data-original="#e1bdfc"
                        ></path>
                        <path
                            d="m239.387 229.465c-.028-.377-.072-.755-.155-1.137-.529-14.696-4.995-27.419-15.208-37.264-.254-16.445-4.618-29.244-15.033-36.838-5.26-18.181-13.415-37.577-23.598-57.823-1.273-3.121-5.93-2.113-5.799 1.255-1.252 18.226-1.333 35.159 1.877 48.459-4.402 10.822-4.473 21.731 1.27 32.782-3.559 10.946-3.715 22.318 1.327 34.265-5.327 11.502-1.345 22.01.093 26.988 5.909 16.704 56.453 6.023 55.226-10.687z"
                            fill="#c1e5ef"
                            data-original="#c1e5ef"
                            className=""
                        ></path>
                        <path
                            d="m239.387 229.465c-.028-.377-.072-.755-.155-1.137-.376-10.437-2.751-19.871-7.746-27.994.491 2.692.791 5.477.897 8.355.073.326.112.649.137.97 1.08 14.257-43.412 23.371-48.614 9.118-.244-.82-.572-1.817-.908-2.961-3.649 10.443-.164 19.743 1.163 24.335 5.909 16.705 56.453 6.024 55.226-10.686z"
                            fill="#a6aaed"
                            data-original="#a6aaed"
                        ></path>
                        <path
                            d="m111.824 245.253c11.746-6.783 20.459-17.609 25.256-30.296 1.363-3.604 3.283-7.081 5.787-10.314 11.958-15.441 33.772-19.819 50.753-10.17 20.252 11.508 26.141 37.532 13.411 56.527-10.96 16.354-28.619 23.175-44.958 22.654-9.518-.303-31.467-6.159-48.132-10.995-8.067-2.339-9.392-13.205-2.117-17.406z"
                            fill="#c2b2eb"
                            data-original="#c2b2eb"
                            className=""
                        ></path>
                        <path
                            d="m193.62 194.474c-16.98-9.648-38.794-5.271-50.753 10.17-2.504 3.233-4.424 6.71-5.787 10.314-4.798 12.687-13.51 23.513-25.256 30.296-7.274 4.2-5.95 15.067 2.118 17.408 16.665 4.836 38.614 10.691 48.132 10.995 16.338.52 33.998-6.301 44.958-22.655 12.729-18.996 6.84-45.02-13.412-56.528zm1.825 37.58c-5.465 13.085-17.173 20.292-29.02 22.107-6.902 1.057-23.583-.169-36.308-1.376-6.159-.585-8.729-8.128-4.113-12.085 7.454-6.389 12.121-15.247 13.692-24.902.446-2.743 1.313-5.47 2.636-8.102 6.32-12.57 21.384-18.597 35.051-14.011 16.3 5.467 24.409 23.17 18.062 38.369z"
                            fill="#ae85ea"
                            data-original="#ae85ea"
                            className=""
                        ></path>
                        <path
                            d="m155.234 234.984c-1.493 0-3.007-.334-4.437-1.039-4.978-2.455-7.023-8.48-4.569-13.458 7.885-15.991 21.096-20.08 22.576-20.494 0 0 9.613-3.632 12.756 5.685 3.324 9.854-7.275 13.657-7.139 13.612-.253.084-6.25 2.144-10.167 10.086-1.748 3.549-5.313 5.607-9.02 5.608z"
                            fill="#ffffff"
                            data-original="#ffffff"
                            className=""
                        ></path>
                        <g fill="#9781dd">
                            <path
                                d="m245.174 501.95h6.106c2.955 0 5.35-2.147 5.35-4.794v-53.412c0-2.648-2.395-4.794-5.35-4.794h-6.106c-19.415 0-35.154 14.103-35.154 31.5 0 17.397 15.739 31.5 35.154 31.5z"
                                fill="#9781dd"
                                data-original="#9781dd"
                            ></path>
                            <path
                                d="m382.397 501.95h5.942c2.875 0 5.206-2.331 5.206-5.206v-58.001c0-2.875-2.331-5.206-5.206-5.206h-5.942c-18.892 0-34.206 15.315-34.206 34.207 0 18.891 15.314 34.206 34.206 34.206z"
                                fill="#9781dd"
                                data-original="#9781dd"
                            ></path>
                            <path
                                d="m171.654 438.95h-6.106c-2.955 0-5.35 2.146-5.35 4.794v53.412c0 2.648 2.396 4.794 5.35 4.794h6.106c19.415 0 35.154-14.103 35.154-31.5 0-17.397-15.739-31.5-35.154-31.5z"
                                fill="#9781dd"
                                data-original="#9781dd"
                            ></path>
                        </g>
                        <path
                            d="m166.019 495.304 39.301.982c-.557-8.869-1.08-17.739-1.302-26.622l-38.631 9.266c.042 5.467.315 10.921.632 16.374z"
                            fill="#8962de"
                            data-original="#8962de"
                        ></path>
                        <path
                            d="m155.373 481.333-51.747 12.412 52.328 1.307c-.264-4.57-.492-9.141-.581-13.719z"
                            fill="#e1bdfc"
                            data-original="#e1bdfc"
                        ></path>
                        <path
                            d="m251.147 469.37h-37.087c.22 9.066.757 18.117 1.326 27.167l35.761.894z"
                            fill="#8962de"
                            data-original="#8962de"
                        ></path>
                        <path
                        ...
                        ></path>
                        <path
                            d="m381.689 469.37h-27.259c2.356 10.457 5.518 20.72 9 30.866l24.593.614v-31.74c-2.204.171-4.33.26-6.334.26z"
                            fill="#8962de"
                            data-original="#8962de"
                        ></path>
                        <path
                            d="m414.161 290.297c-1.298 3.018-2.513 6.076-3.622 9.181 21.677 22.989 37.05 53.65 39.546 82.632 1.678 19.486-1.371 45.004-9.505 60.885-7.102 13.867-25.584 21.697-42.507 24.798v33.309l21.312.533c22.633 0 43.7-12.069 54.676-31.863 10.176-18.351 15.877-38.887 15.877-60.575 0-49.961-30.217-93.832-75.777-118.9z"
                            fill="#e1bdfc"
                            data-original="#e1bdfc"
                        ></path>
                        <path
                            d="m469.927 137.738 8.256 23.213c.353.994 1.053 1.781 1.936 2.179l20.624 9.292c2.914 1.313 2.914 5.955 0 7.268l-20.624 9.292c-.883.398-1.583 1.185-1.936 2.179l-8.256 23.213c-1.166 3.279-5.291 3.279-6.457 0l-8.255-23.213c-.354-.994-1.053-1.781-1.936-2.179l-20.624-9.292c-2.914-1.313-2.914-5.955 0-7.268l20.624-9.292c.883-.398 1.583-1.185 1.936-2.179l8.255-23.213c1.166-3.28 5.29-3.28 6.457 0z"
                            fill="#c1e5ef"
                            data-original="#c1e5ef"
                        ...
                        <ellipse
                            ...
                            rx="12.248"
                            ry="12.248"
                            transform="matrix(.973 -.23 .23 .973 -5.408 99.212)"
                            data-original="#96b4eb"
                        ></ellipse>
                        <path
                            d="m258.101 40.981c0 5.254-4.259 9.513-9.513 9.513s-9.513-4.259-9.513-9.513 4.259-9.513 9.513-9.513c5.253.001 9.513 4.26 9.513 9.513z"
                            fill="#96b4eb"
                            data-original="#96b4eb"
                        ></path>
                    </g>
                    <g fill="#3c122c">
                        ...
                        <path
                            d="m194.596 375.879c-10.097 0-18.311-8.696-18.311-19.384 0-3.33 2.7-6.03 6.03-6.03s6.03 2.7 6.03 6.03c0 4.039 2.804 7.324 6.251 7.324s6.252-3.285 6.252-7.324c0-3.33 2.7-6.03 6.03-6.03s6.03 2.7 6.03 6.03c0 10.688-8.215 19.384-18.312 19.384z"
                            fill="#3c122c"
                            data-original="#3c122c"
                            className=""
                        ></path>
